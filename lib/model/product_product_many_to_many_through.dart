...
class ProductProductManyToManyThrough {
...
/* With Published chosen, won't be shown after this time */
  ...
  static List<ProductProductManyToManyThrough> listFromJson(List<dynamic> json) {
    return json == null ? new List<ProductProductManyToManyThrough>() : json.map((value) => new ProductProductManyToManyThrough.fromJson(value)).toList();
  }

  static Map<String, ProductProductManyToManyThrough> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ProductProductManyToManyThrough>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new ProductProductManyToManyThrough.fromJson(value));
    }
    return map;
  }
}
