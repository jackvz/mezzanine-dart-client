...
class PagesApi {
  ...
  ///
  /// Create
  Future<Page> pagesCreate(Page data) async {
  ...
  ///
  /// Destroy
  Future pagesDelete(int id) async {
  ...
  ///
  /// List all
  Future<List<Page>> pagesList() async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<Page>') as List).map((item) => item as Page).toList();
    } else {
      return null;
    }
  }
  ...
  ///
  /// Partial update
  Future<Page> pagesPartialUpdate(int id, Page data) async {
    Object postBody = data;
  ...
  ///
  /// Update
  Future<Page> pagesUpdate(int id, Page data) async {
    Object postBody = data;
